...
class MCControlPlugin extends Plugin {
    ...
    getTools() {
        return [
            ...
            { type: 'function', function: { name: 'mc_turn', description: '转动视角', parameters: { type: 'object', properties: { yaw: { type: 'number', description: '水平角度' }, pitch: { type: 'number', description: '垂直角度' } }, required: ['yaw', 'pitch'] } } },
